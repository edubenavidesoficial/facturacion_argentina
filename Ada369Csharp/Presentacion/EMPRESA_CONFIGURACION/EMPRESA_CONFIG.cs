...
namespace Ada369Csharp.Presentacion.EMPRESA_CONFIGURACION
{
    public partial class EMPRESA_CONFIG : Form
    {
        ...
        {
            Dispose();
            ////Presentacion.CONFIGURACION .PANEL_CONFIGURACIONES.pa
            ////try
            ////{
            ////foreach (Form frm in Application.OpenForms)
            ////{
            ////    if (frm.GetType() == typeof(Presentacion.MASCARAS.MASCARA))
            ////    {
            ////        frm.Hide  ();
            ////            frm.e
            ////        //Presentacion.MASCARAS.MASCARA ff = new Presentacion.MASCARAS.MASCARA();
            ////        //ff.Show();
            ////        //break;
            ////    }
            ////}
